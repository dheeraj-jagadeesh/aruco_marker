...
class ArucoMaintenanceBoard:
    ...
    def load_config(self):
        ...
        try:
            ...
            config = {
                "board_width": 600,
                "board_height": 800,
                "reference_board_height": 400,
                "reference_square_fraction": 0.45,
                "min_square_size": 20,
                "aruco_dict": "DICT_4X4_50",
                "object_relative_positions": [
                    [0.17, 0.17], [0.5, 0.17], [0.83, 0.17],
                    [0.17, 0.5], [0.83, 0.5],
                    [0.17, 0.83], [0.5, 0.83], [0.83, 0.83]
                ],
                "output_video": "output_maintenance_board.mp4"
            }
    ...
    def get_board_homography(self, corners):
        ...
        dst = np.array([[0, 0], [self.board_width, 0], [self.board_width, self.board_height], [0, self.board_height]], dtype=np.float32)
...
def main():
    detector = ArucoMaintenanceBoard()
